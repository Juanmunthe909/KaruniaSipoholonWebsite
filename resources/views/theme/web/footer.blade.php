 ...
 <footer class="footer" id="footer">
             ...
             <div class="row">
                 ...
                 <div class="col-md-4">
                     <div class="contact-us">
                         ...
                         <div class="detail">
                             <ul>
                                 <li class="phone"><i class="icon-telephone"></i> <span>+628 22 59 117 87</span></li>
                                 <li class="email"><i class="icon-email-1"></i> <span>KaruniaSipoholon@gmail.com</span>
                                 </li>
                                 <li class="location"><i class="icon-home"></i> <span>Jl. Balige Sipoholon Tarutung
                                     </span></li>
                                 <iframe width="360" height="315"
                                     src="https://www.youtube.com/embed/z5E-mvP1Tt0?si=uWg0UKZcJyzP5l9D"
     ...
     <div class="copyrights">
         <div class="container">
             <div class="row">
                 <div class="col-md-12">
                     <span>Copyright © 2023 Karunia Sipoholon - Institut Teknologi Del <a href="#.">
                         </a></span>
                 </div>
             </div>
         </div>
